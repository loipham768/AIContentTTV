...
const envFile = dotenv.readFileSync('.env.local', 'utf8')
...
<section id="skills">
  <div class="container">
    ...
    <div class="skills-grid">
      <div class="skill-card"><div class="skill-icon">🎨</div><div class="skill-name">UI Design</div><div style="font-size:.8rem;color:#9ca3af">Figma, Adobe XD</div><div class="skill-bar"><div class="skill-fill" style="width:95%"></div></div></div>
      <div class="skill-card"><div class="skill-icon">🖌️</div><div class="skill-name">Brand Identity</div><div style="font-size:.8rem;color:#9ca3af">Illustrator, InDesign</div><div class="skill-bar"><div class="skill-fill" style="width:88%"></div></div></div>
      <div class="skill-card"><div class="skill-icon">⚡</div><div class="skill-name">Motion Design</div><div style="font-size:.8rem;color:#9ca3af">After Effects, Rive</div><div class="skill-bar"><div class="skill-fill" style="width:78%"></div></div></div>
      <div class="skill-card"><div class="skill-icon">💻</div><div class="skill-name">Front-end</div><div style="font-size:.8rem;color:#9ca3af">HTML, CSS, React</div><div class="skill-bar"><div class="skill-fill" style="width:72%"></div></div></div>
    </div>
    <div class="stats">
...
<section id="projects" style="background:rgba(255,255,255,.02)">
  <div class="container">
    ...
    <div class="projects-grid">
      <div class="project-card"><div class="project-thumb p1">🛍️</div><div class="project-info"><div class="project-title">Redesign App Thương Mại</div><div class="project-desc">Thiết kế lại toàn bộ trải nghiệm mua sắm cho ứng dụng với 500k+ người dùng, tăng conversion 34%.</div><div class="project-tags"><span class="ptag">Mobile</span><span class="ptag">UX Research</span><span class="ptag">Figma</span></div></div></div>
      <div class="project-card"><div class="project-thumb p2">🎯</div><div class="project-info"><div class="project-title">Brand Identity Startup</div><div class="project-desc">Xây dựng nhận diện thương hiệu hoàn chỉnh từ logo, bộ màu, typography đến brand guideline.</div><div class="project-tags"><span class="ptag">Branding</span><span class="ptag">Logo</span><span class="ptag">Guidelines</span></div></div></div>
      <div class="project-card"><div class="project-thumb p3">📊</div><div class="project-info"><div class="project-title">Dashboard Analytics SaaS</div><div class="project-desc">Thiết kế hệ thống dashboard phức tạp với 50+ component, dark mode, responsive hoàn toàn.</div><div class="project-tags"><span class="ptag">Dashboard</span><span class="ptag">SaaS</span><span class="ptag">Design System</span></div></div></div>
    </div>
  </div>
</section>
<section id="contact">
  <div class="container">
    <div class="contact-section">
      ...
      <div class="social-links"><a href="#" class="social-link">in</a><a href="#" class="social-link">be</a><a href="#" class="social-link">dr</a><a href="#" class="social-link">gh</a></div>
    </div>
  </div>
</section>
<footer><p>© 2025 Nguyễn Minh Thiết · Thiết kế với ❤ tại Việt Nam</p></footer>
</body>
</html>`,
  },
  {
...
.terminal-prompt{color:#3fb950;font-size:.9rem;margin-bottom:20px}
...
.hero-role{font-size:1.1rem;color:#3fb950;margin-bottom:20px}
...
.section-num{color:#58a6ff;font-size:.9rem}
...
.repo-name{color:#58a6ff;font-weight:600;font-size:.95rem}
...
.skill-pct{color:#58a6ff;font-size:.8rem}
...
.tl-date{font-size:.75rem;color:#58a6ff;margin-bottom:6px}
...
.contact-email{font-size:1.3rem;color:#58a6ff;margin:16px 0}
...
<nav class="nav">
  ...
  <div class="nav-links"><a href="#projects">projects</a><a href="#skills">skills</a><a href="#exp">experience</a><a href="#contact">contact</a></div>
</nav>
<div class="hero">
  <div>
    ...
    <div class="tech-stack">
      <span class="tech-badge tb-yellow">JavaScript</span><span class="tech-badge tb-blue">TypeScript</span><span class="tech-badge tb-green">Node.js</span><span class="tech-badge tb-blue">React</span><span class="tech-badge tb-purple">Next.js</span><span class="tech-badge tb-yellow">PostgreSQL</span><span class="tech-badge tb-blue">Docker</span>
    </div>
...
<section id="projects">
  <div class="section-header"><span class="section-num">01.</span><h2>Featured Repos</h2><div class="section-line"></div></div>
  <div class="repos-grid">
    <div class="repo-card"><div class="repo-top"><span>📦</span><span class="repo-name">nextjs-saas-starter</span></div><div class="repo-desc">Boilerplate hoàn chỉnh cho SaaS với auth, billing, admin dashboard, dark mode. Tiết kiệm 2 tuần setup.</div><div class="repo-meta"><div class="repo-lang"><div class="lang-dot" style="background:#f1e05a"></div>TypeScript</div><div class="repo-stars">⭐ 847</div></div></div>
    <div class="repo-card"><div class="repo-top"><span>🚀</span><span class="repo-name">realtime-collab-editor</span></div><div class="repo-desc">Editor cộng tác thời gian thực dùng CRDTs, WebSocket, hỗ trợ 100+ concurrent users.</div><div class="repo-meta"><div class="repo-lang"><div class="lang-dot" style="background:#3572A5"></div>Python</div><div class="repo-stars">⭐ 423</div></div></div>
    <div class="repo-card"><div class="repo-top"><span>🤖</span><span class="repo-name">ai-code-reviewer</span></div><div class="repo-desc">GitHub Action tích hợp LLM tự động review code, phát hiện bug và security issues trong PR.</div><div class="repo-meta"><div class="repo-lang"><div class="lang-dot" style="background:#f1e05a"></div>TypeScript</div><div class="repo-stars">⭐ 1.2k</div></div></div>
    <div class="repo-card"><div class="repo-top"><span>🗄️</span><span class="repo-name">pg-vector-search</span></div><div class="repo-desc">Wrapper đơn giản cho pgvector, semantic search với embeddings, hỗ trợ RAG pipeline.</div><div class="repo-meta"><div class="repo-lang"><div class="lang-dot" style="background:#e34c26"></div>Go</div><div class="repo-stars">⭐ 312</div></div></div>
  </div>
</section>
<section id="skills">
  <div class="section-header"><span class="section-num">02.</span><h2>Skills &amp; Tools</h2><div class="section-line"></div></div>
...
<section id="exp">
  <div class="section-header"><span class="section-num">03.</span><h2>Experience</h2><div class="section-line"></div></div>
  <div class="timeline">
    <div class="tl-item"><div class="tl-dot"></div><div class="tl-date">2023 – Hiện tại</div><div class="tl-title">Senior Fullstack Developer</div><div class="tl-company">TechVN Startup · Remote</div><div class="tl-desc">Lead technical architecture cho platform B2B SaaS, 15k+ active users. Cải thiện performance 60%.</div></div>
    <div class="tl-item"><div class="tl-dot"></div><div class="tl-date">2021 – 2023</div><div class="tl-title">Fullstack Developer</div><div class="tl-company">FPT Software · Hà Nội</div><div class="tl-desc">Phát triển microservices cho hệ thống payment, xử lý 50k transactions/ngày. Team lead nhóm 5 người.</div></div>
    <div class="tl-item"><div class="tl-dot"></div><div class="tl-date">2020 – 2021</div><div class="tl-title">Frontend Developer</div><div class="tl-company">Freelance</div><div class="tl-desc">Xây dựng 20+ website cho khách hàng SMB, tập trung vào performance, SEO và UX tốt.</div></div>
  </div>
</section>
<section id="contact">
  <div class="section-header"><span class="section-num">04.</span><h2>Contact</h2><div class="section-line"></div></div>
...
header{position:fixed;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:space-between;padding:20px 40px}
...
.gallery-item-inner{transition:transform .4s}
...
<header>
  ...
  <nav><a href="#gallery">Gallery</a><a href="#about">About</a><a href="#services">Services</a><a href="#contact">Contact</a></nav>
</header>
<div class="hero">
  <div class="hero-bg"></div>
  <div class="hero-grid"><div class="hero-cell-1"></div><div class="hero-cell-2"></div><div class="hero-cell-3"></div><div class="hero-cell-4"></div></div>
...
<section id="gallery">
  ...
  <div class="gallery-masonry">
    <div class="gallery-item"><div class="gallery-item-inner g-tall" style="background:linear-gradient(160deg,#1a1a2e,#16213e)"></div></div>
    <div class="gallery-item"><div class="gallery-item-inner g-wide" style="background:linear-gradient(160deg,#1e2a1e,#2d4a2d)"></div></div>
    <div class="gallery-item"><div class="gallery-item-inner g-square" style="background:linear-gradient(160deg,#2a1a1a,#4a2d2d)"></div></div>
    <div class="gallery-item"><div class="gallery-item-inner g-wide" style="background:linear-gradient(160deg,#1a1a2a,#2d2d4a)"></div></div>
    <div class="gallery-item"><div class="gallery-item-inner g-tall" style="background:linear-gradient(160deg,#2a2a1a,#4a4a2d)"></div></div>
    <div class="gallery-item"><div class="gallery-item-inner g-square" style="background:linear-gradient(160deg,#1a2a2a,#2d4a4a)"></div></div>
  </div>
</section>
...
<section id="services">
  ...
  <div class="services">
    <div class="service-item"><div class="service-num">01</div><div class="service-name">Ảnh cưới</div><div class="service-desc">Lưu giữ mọi cảm xúc của ngày đặc biệt nhất cuộc đời bạn</div></div>
    <div class="service-item"><div class="service-num">02</div><div class="service-name">Chân dung</div><div class="service-desc">Headshot chuyên nghiệp, ảnh cá nhân, lifestyle portrait</div></div>
    <div class="service-item"><div class="service-num">03</div><div class="service-name">Thương mại</div><div class="service-desc">Ảnh sản phẩm, thương hiệu, nội thất, ẩm thực</div></div>
    <div class="service-item"><div class="service-num">04</div><div class="service-name">Sự kiện</div><div class="service-desc">Hội nghị, ra mắt sản phẩm, tiệc sinh nhật, sự kiện công ty</div></div>
  </div>
</section>
...
<footer><span>© 2025 Lê Ánh Photography</span><span>Hà Nội, Việt Nam</span></footer>
</body>
</html>`,
  },
  {
...
<div class="cv">
  <div class="sidebar">
    ...
    <div class="sb-section">
      <div class="sb-section-title">Kỹ năng</div>
    ...
    <div class="sb-section">
      ...
      <div class="lang-item"><span>Tiếng Việt</span><div class="lang-dots"><span class="dot filled"></span><span class="dot filled"></span><span class="dot filled"></span><span class="dot filled"></span><span class="dot filled"></span></div></div>
      <div class="lang-item"><span>Tiếng Anh</span><div class="lang-dots"><span class="dot filled"></span><span class="dot filled"></span><span class="dot filled"></span><span class="dot filled"></span><span class="dot"></span></div></div>
      <div class="lang-item"><span>Tiếng Nhật</span><div class="lang-dots"><span class="dot filled"></span><span class="dot filled"></span><span class="dot"></span><span class="dot"></span><span class="dot"></span></div></div>
    </div>
    <div class="sb-section">
      <div class="sb-section-title">Công cụ</div>
      <div class="tag-list"><span class="tag">Google Ads</span><span class="tag">Meta Ads</span><span class="tag">HubSpot</span><span class="tag">GA4</span><span class="tag">Canva</span><span class="tag">Mailchimp</span><span class="tag">Semrush</span><span class="tag">Figma</span></div>
    </div>
  </div>
  <div class="main">
    ...
    <div class="section">
      ...
      <div class="timeline-item">
        ...
        <div class="tl-desc"><ul><li>Xây dựng và quản lý toàn bộ funnel marketing B2B, từ awareness đến retention</li><li>Tăng organic traffic 280% trong 12 tháng qua chiến lược SEO & content</li><li>Quản lý ngân sách ads $150k/tháng, ROAS trung bình 4.2x</li></ul></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tl-desc"><ul><li>Phụ trách toàn bộ kênh paid ads: Facebook, Google, TikTok, Zalo</li><li>Xây dựng hệ thống email automation tăng repeat purchase 45%</li></ul></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tl-desc"><ul><li>Quản lý 15+ trang mạng xã hội cho khách hàng đa ngành</li></ul></div>
      </div>
    </div>
    <div class="section">
      <div class="section-header"><div class="section-icon">🎓</div><div class="section-title">Học vấn</div></div>
      <div class="edu-item"><div class="edu-icon">🏛️</div><div><div class="edu-degree">Cử nhân Quản trị Kinh doanh</div><div class="edu-school">ĐH Kinh tế TP.HCM (UEH)</div><div class="edu-year">2013 – 2017 · GPA: 3.5/4.0</div></div></div>
    </div>
    <div class="section">
...
<div class="cv">
  ...
  <div class="section">
    ...
    <div style="font-size:.88rem;color:#374151;line-height:1.8">Kỹ sư phần mềm với 6 năm kinh nghiệm phát triển hệ thống backend quy mô lớn. Thành thạo Java, Go, và kiến trúc microservices. Đã thiết kế và vận hành hệ thống xử lý 10 triệu request/ngày.</div>
  </div>
  <div class="section">
    <div class="section-title">Kinh nghiệm làm việc</div>
    <div class="job">
      <div class="job-header"><div class="job-title">Senior Software Engineer</div><div class="job-date">Tháng 4/2021 – Hiện tại</div></div>
    ...
    <div class="job">
      <div class="job-header"><div class="job-title">Software Engineer</div><div class="job-date">Tháng 6/2019 – Tháng 3/2021</div></div>
    ...
    <div class="job">
      <div class="job-header"><div class="job-title">Junior Backend Developer</div><div class="job-date">Tháng 7/2018 – Tháng 5/2019</div></div>
      <div class="job-company">FPT Software · Hà Nội</div>
      <div class="job-desc"><ul>
        <li>Phát triển REST API cho hệ thống quản lý nhân sự 10,000+ nhân viên</li>
        <li>Tham gia dự án outsource cho khách hàng Nhật Bản</li>
      </ul></div>
    </div>
  </div>
  <div class="section">
    ...
    <div class="edu-item">
      <div class="edu-left"><div class="edu-degree">Kỹ sư Công nghệ Thông tin</div><div class="edu-school">Trường ĐH Bách Khoa Hà Nội (HUST)</div></div>
  ...
  <div class="section">
    ...
    <div class="achievement-item"><div class="ach-year">2023</div><div class="ach-text"><span class="ach-title">Giải Nhất Hackathon VNG Innovation Day</span> — Xây dựng tool phân tích log tự động phát hiện anomaly</div></div>
    <div class="achievement-item"><div class="ach-year">2022</div><div class="ach-text"><span class="ach-title">Speaker tại Vietnam Web Summit</span> — Trình bày "Lessons from scaling to 10M users"</div></div>
    <div class="achievement-item"><div class="ach-year">2021</div><div class="ach-text"><span class="ach-title">Open Source Contributor</span> — Contributor tích cực tại Apache Kafka ecosystem (45+ PRs merged)</div></div>
  </div>
  <div class="section">
...
.sb-name{font-size:1.35rem;font-weight:800;text-align:center;color:#ecfdf5;position:relative;z-index:1;margin-bottom:6px}
...
.main-summary{font-size:.88rem;color:#4b5563;line-height:1.8;margin-bottom:32px}
...
@media(max-width:400px){.exp-item{grid-template-columns:1fr}}
...
<div class="cv">
  <div class="sidebar">
    ...
    <div class="sb-body">
      ...
      <div class="sb-sec">
        ...
        <div class="interest-tags"><span class="itag">📸 Photography</span><span class="itag">✍ Blogging</span><span class="itag">🎵 Music</span><span class="itag">🏃 Yoga</span><span class="itag">✈ Travel</span></div>
      </div>
      <div class="sb-sec">
  ...
  <div class="main">
    ...
    <div class="main-summary">Content creator và brand strategist với 5 năm kinh nghiệm xây dựng thương hiệu cá nhân và doanh nghiệp. Đã giúp 20+ thương hiệu tăng trưởng organic following từ 0 lên 100k+.</div>
    <div class="m-section">
      <div class="m-section-title"><div class="m-section-icon">💼</div><div class="m-section-text">Kinh nghiệm</div></div>
      <div class="exp-item">
        <div class="exp-date-col"><div class="exp-year-range">2022<br>Nay</div><div class="exp-duration">~2 năm</div></div>
        <div class="exp-content-col">
          <div class="exp-title">Head of Content</div>
          <div class="exp-company">GreenLife Brand · Đà Nẵng</div>
          <div class="exp-desc"><ul><li>Dẫn dắt team content 6 người, sản xuất 150+ assets/tháng đa nền tảng</li><li>Xây dựng Instagram từ 8k lên 185k followers trong 14 tháng</li><li>Tăng doanh thu từ social commerce 320% YoY</li></ul></div>
        </div>
      </div>
      <div class="exp-item">
        <div class="exp-date-col"><div class="exp-year-range">2020<br>2022</div><div class="exp-duration">2 năm</div></div>
        <div class="exp-content-col">
          <div class="exp-title">Content Marketing Specialist</div>
          <div class="exp-company">Creative Agency X · TP.HCM</div>
          <div class="exp-desc"><ul><li>Phụ trách content cho 8 brand clients đồng thời</li><li>Viral campaign đạt 2M+ reach cho nhãn hàng FMCG</li></ul></div>
        </div>
      </div>
      <div class="exp-item">
        <div class="exp-date-col"><div class="exp-year-range">2019<br>2020</div><div class="exp-duration">1 năm</div></div>
        <div class="exp-content-col">
          <div class="exp-title">Freelance Content Creator</div>
          <div class="exp-company">Tự do</div>
          <div class="exp-desc"><ul><li>Blog cá nhân đạt 50k pageview/tháng về lifestyle & beauty</li><li>Brand collaboration với 15+ nhãn hàng beauty & fashion</li></ul></div>
        </div>
      </div>
    </div>
    <div class="m-section">
      <div class="m-section-title"><div class="m-section-icon">🎓</div><div class="m-section-text">Học vấn</div></div>
      <div class="edu-card"><div class="edu-degree">Cử nhân Truyền thông & Marketing</div><div class="edu-school">Trường ĐH Ngoại thương — Cơ sở Đà Nẵng</div><div class="edu-year">2015 – 2019 · Tốt nghiệp Xuất sắc · GPA 3.7/4.0</div></div>
    </div>
    <div class="m-section">
      <div class="m-section-title"><div class="m-section-icon">🏆</div><div class="m-section-text">Thành tích nổi bật</div></div>
      <div class="award-item"><div class="award-badge">🥇</div><div><div class="award-title">Top 30 Content Creator Vietnam 2023</div><div class="award-desc">Vietnam Martech bình chọn trong danh sách creator có tầm ảnh hưởng nhất ngành</div></div></div>
      <div class="award-item"><div class="award-badge">🎖️</div><div><div class="award-title">Best Social Campaign — Smarties Vietnam 2022</div><div class="award-desc">Chiến dịch #GreenLiving đạt giải thưởng marketing xuất sắc nhất hạng mục Social</div></div></div>
    </div>
  </div>
</div>
</body>
...
async function main() {
  ...
  for (const tpl of TEMPLATES) {
    const existing = await Template.findOne({ id: tpl.id })
    if (existing) {
      await Template.updateOne({ id: tpl.id }, { $set: tpl })
      console.log(`  updated: ${tpl.id}`)
      updated++
    } else {
      const maxOrderDoc = await Template.findOne({}, { order: 1 }).sort({ order: -1 }).lean() as any
      const order = (maxOrderDoc?.order ?? -1) + 1
      await Template.create({ ...tpl, order })
