...
const TESTIMONIALS = [
  {
    ...
    quote: 'Trước đây tôi mất cả buổi để làm một banner. Bây giờ AI tạo xong trong 1 phút, tôi chỉ cần chỉnh vài chi tiết rồi paste vào là xong. Năng suất tăng gấp 5 lần.',
  ...
  },
  {
    ...
    quote: 'HTML inline CSS dán vào Sapo không bị lỗi giao diện. Tôi không cần biết code vẫn tạo được khối content đẹp như chuyên nghiệp thiết kế.',
  ...
  },
  {
    ...
    quote: 'Nhập tiếng Việt hoàn toàn tự nhiên mà AI vẫn hiểu đúng ý định. Tính năng lưu lịch sử giúp tôi tái sử dụng template cũ rất tiện lợi.',
  ...
  },
  {
    ...
    quote: 'Tôi dùng tool này mỗi ngày để tạo banner khuyến mãi cho WordPress. Tốc độ nhanh, HTML sạch, không cần plugin thêm hay lo CSS conflict.',
  ...
  },
  {
    ...
    quote: 'Khách hàng cứ nghĩ tôi thuê designer riêng, nhưng thực ra AI làm hết chỉ trong vài giây. Tôi tiết kiệm được 3-4 triệu/tháng tiền outsource.',
  ...
  },
  {
    ...
    quote: 'Dùng cho team marketing 5 người. Mỗi chiến dịch tiết kiệm được 2-3 ngày công so với làm thủ công. ROI cực kỳ cao so với chi phí đăng ký.',
  ...
  },
  {
    ...
    quote: 'Rất phù hợp cho team nhỏ không có designer. Chỉ cần mô tả bằng tiếng Việt là ra ngay banner đẹp để đăng lên Shopee, Lazada hay Facebook.',
  ...
  },
  {
    ...
    quote: 'Tôi integrate thẳng vào quy trình build site cho khách hàng. Inline CSS không conflict với theme, khách mới hoàn toàn cũng tự chỉnh sửa được.',
...
export default function TestimonialsCarousel() {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #4c1d95 0%, #6b21a8 50%, #3b0764 100%)' }}
