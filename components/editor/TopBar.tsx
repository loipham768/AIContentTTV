...
export default function TopBar({
  ...
  async function handleCopyHtml() {
    ...
    try {
      await navigator.clipboard.writeText(html + (scripts ? '\n' + scripts : ''))
      setCopied(true)
