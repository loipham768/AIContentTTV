...
const DETAILED: any[] = [
  ...
  { userId: 'seed_v1_015', userEmail: 'dinh.quoc.bao.startup@gmail.com', userName: 'Đinh Quốc Bảo', plan: 'pro', rating: 5, content: 'Startup không có budget thuê designer full-time. AITaoPage là giải pháp hoàn hảo, landing page ra đúng chuẩn, tích hợp vào Next.js cực mượt. Đội dev rất thích.', isApproved: true, createdAt: new Date('2025-06-10T13:00:00Z') },
]
...
const CONTENTS = [
  ...
  'So với các tool khác tôi đã dùng thì AITaoPage nhanh hơn hẳn và ít phải chỉnh sửa hơn nhiều. Workflow mượt hơn rõ rệt.',
  ...
  'Tôi là người mới học marketing, AITaoPage giúp tôi tự tạo được visual content trông chuyên nghiệp ngay từ đầu. Tự tin hơn nhiều.',
  ...
  'Không có nền tảng về code hay design nhưng vẫn tự làm được banner chuẩn. AITaoPage giải quyết vấn đề này hoàn toàn.',
