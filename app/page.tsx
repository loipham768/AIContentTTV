...
const FEATURES = [
  ...
  },
  {
    ...
    title: '3 loại nội dung, 1 công cụ',
...
const CONTENT_TYPES = [
  {
    ...
    examples: ['Bán sản phẩm skincare', 'Khóa học lập trình', 'Agency thiết kế', 'Ra mắt app mobile'],
  },
  {
    emoji: '📝',
    ...
    examples: ['Blog SEO lên Top Google', 'Review sản phẩm', 'Hướng dẫn & tutorial', 'Mô tả sản phẩm'],
  },
  {
    emoji: '📣',
    ...
    examples: ['Banner Facebook Ads', 'Google Display Ads', 'Email marketing', 'Carousel quảng cáo'],
  },
]
...
const STEPS = [
  {
    ...
    preview: (
      <div className="bg-white rounded-xl border border-violet-100 p-4 shadow-sm space-y-2">
        <div className="text-xs text-gray-400 mb-3 font-medium">AI đang hỏi thêm thông tin...</div>
        ...
        <div className="flex gap-2 mt-2">
          {['Xanh dương', 'Tím', 'Tối (Dark)'].map(c => (
            <span key={c} className="text-xs px-2 py-1 bg-white border border-gray-200 rounded-full text-gray-600 cursor-pointer hover:border-violet-300">{c}</span>
          ))}
        </div>
      </div>
    ),
    ...
    preview: (
      <div className="bg-white rounded-xl border border-blue-100 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-gray-500">AI đang tạo landing page...</span>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg p-4 text-white">
          <div className="text-xs text-blue-200 mb-1">KHÓA HỌC LẬP TRÌNH WEB</div>
          <div className="font-bold text-base mb-1">Từ 0 đến Junior Developer</div>
          <div className="text-blue-100 text-xs mb-3">Học trong 3 tháng — có việc làm ngay</div>
          <div className="flex gap-2">
            <div className="bg-yellow-400 text-gray-900 text-xs font-bold px-3 py-1.5 rounded-lg">Đăng ký ngay</div>
            <div className="border border-white/40 text-white text-xs px-3 py-1.5 rounded-lg">Xem chương trình</div>
          </div>
        </div>
        <div className="mt-2 flex items-center gap-1.5">
          <Sparkles className="w-3 h-3 text-indigo-500" />
          <span className="text-xs text-gray-400">HTML đầy đủ · inline CSS · sẵn sàng chỉnh sửa</span>
        </div>
      </div>
    ),
  },
    ...
    preview: (
      <div className="bg-white rounded-xl border border-emerald-100 p-4 shadow-sm">
        ...
        <div className="text-xs font-mono bg-gray-900 rounded-lg p-3 text-left leading-relaxed mb-3">
          ...
          <span className="text-gray-300">=&quot;background:#2563eb;...&quot;</span>
          <span className="text-blue-400">&gt;</span>
          <br />
          <span className="text-gray-500 ml-3">&lt;</span>
          <span className="text-blue-400">h1</span>
          <span className="text-yellow-300"> style</span>
          <span className="text-gray-300">=&quot;color:#fff;font-size:32px&quot;</span>
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="hero-title text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
                Landing page, bài viết,<br className="hidden sm:block" />
                quảng cáo —
              ...
              <p className="hero-subtitle text-lg sm:text-xl text-gray-500 max-w-xl mx-auto lg:mx-0 mb-8">
                Mô tả bằng tiếng Việt, AI tạo HTML chuẩn inline CSS.
                Chỉnh sửa kéo thả trong editor — dán ngay vào Haravan, Sapo, WordPress.
              </p>

              {/* Content type pills */}
              <div className="flex flex-wrap justify-center lg:justify-start gap-2 mb-8">
                {[
                  { label: '🏠 Landing Page', color: 'bg-indigo-100 text-indigo-700 border-indigo-200' },
                  { label: '📝 Bài Viết & Blog', color: 'bg-blue-100 text-blue-700 border-blue-200' },
                  { label: '📣 Quảng Cáo', color: 'bg-rose-100 text-rose-700 border-rose-200' },
                ].map(({ label, color }) => (
                  <span key={label} className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${color}`}>
                    {label}
                  </span>
                ))}
              </div>
              ...
              <div className="hero-stats flex flex-wrap justify-center lg:justify-start gap-8 mt-10 pt-10 border-t border-indigo-100">
                {[
                  { value: '3 loại', label: 'nội dung có thể tạo', grad: 'from-indigo-600 to-violet-600' },
                  { value: '< 1s', label: 'thời gian tạo HTML', grad: 'from-violet-600 to-purple-600' },
                  { value: '6 CMS', label: 'tương thích hoàn hảo', grad: 'from-blue-500 to-cyan-500' },
            ...
            <div className="hero-mockup flex-1 w-full max-w-lg relative">
              ...
              <div className="hidden sm:block absolute -bottom-5 -right-4 z-20 bg-white rounded-2xl shadow-xl px-4 py-3 border border-violet-100 animate-float-slow">
                <div className="text-xs text-gray-400 mb-0.5">HTML sẵn sàng dán vào CMS</div>
                <div className="text-sm font-extrabold bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Haravan · Sapo · WordPress</div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl ring-2 ring-indigo-500/20">
                ...
                <div className="flex bg-gray-100" style={{ height: '340px' }}>
                  <div className="flex-1 p-3 overflow-hidden flex flex-col gap-2">
                    ...
                    <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-200 flex flex-col gap-2 flex-1">
                      ...
                      <div className="flex gap-1.5 flex-wrap">
                        {['🏠 Landing Page', '📝 Bài viết', '📣 Quảng cáo'].map(t => (
                          <span key={t} className={`text-xs px-2 py-1 rounded-full border ${t.startsWith('🏠') ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white border-gray-200 text-gray-600'}`}>{t}</span>
                        ))}
                      </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 rounded-xl p-3 text-white text-center flex-shrink-0">
                      <div className="text-xs text-indigo-200 mb-0.5">KHÓA HỌC FULLSTACK</div>
                      <div className="font-bold text-sm mb-1.5">Từ 0 đến Junior Dev</div>
                  ...
                  <div className="w-32 bg-white border-l border-gray-200 p-2.5 hidden xl:flex flex-col gap-2 shrink-0">
                    ...
                    {[
                      { label: 'Màu nền', content: <div className="h-5 rounded bg-gradient-to-r from-indigo-600 to-violet-600 border border-gray-200" /> },
                      { label: 'Font', content: <div className="h-5 bg-gray-100 rounded border border-gray-200 flex items-center px-1.5 text-xs text-gray-600">24px</div> },
                      { label: 'Radius', content: <div className="h-5 bg-gray-100 rounded border border-gray-200 flex items-center px-1.5 text-xs text-gray-600">12px</div> },
                    ].map(({ label, content }) => (
                      <div key={label}>
                ...
                <div className="h-7 bg-gray-900 flex items-center px-4 gap-2">
                  ...
                  <span className="text-gray-400 text-xs">HTML inline CSS · 0 JS · Dán vào CMS ngay</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <ScrollReveal className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">3 loại nội dung bạn có thể tạo</h2>
            <p className="text-gray-500">Mỗi loại được tối ưu với AI phù hợp — đúng mục đích, đúng định dạng</p>
          </ScrollReveal>

          <div className="grid md:grid-cols-3 gap-6">
            {CONTENT_TYPES.map((ct, i) => (
              <ScrollReveal key={ct.title} delay={i * 80} className="h-full">
                <div className={`h-full rounded-2xl bg-gradient-to-br ${ct.bg} border ${ct.border} p-6 flex flex-col`}>
                  <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${ct.grad} flex items-center justify-center text-2xl mb-4 shadow-md flex-shrink-0`}>
                    {ct.emoji}
                  </div>
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="text-lg font-bold text-gray-900">{ct.title}</h3>
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${ct.badgeColor} flex-shrink-0 ml-2`}>{ct.badge}</span>
                  </div>
                  <p className="text-sm text-gray-600 mb-4">{ct.desc}</p>
                  <ul className="space-y-1.5 flex-1">
                    {ct.examples.map(ex => (
                      <li key={ex} className="flex items-center gap-2 text-sm text-gray-700">
                        <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 flex-shrink-0" /> {ex}
                      </li>
                    ))}
                  </ul>
      ...
      <section id="how-it-works" className="py-24" style={{ background: 'linear-gradient(135deg, #dbeafe 0%, #ffffff 50%, #d1fae5 100%)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Chỉ 3 bước</h2>
            <p className="text-gray-500">Từ ý tưởng đến HTML production-ready trong chưa đầy một phút</p>
          </ScrollReveal>
      ...
      <section className="py-24" style={{ background: 'linear-gradient(135deg, #ede9fe 0%, #faf5ff 50%, #e0e7ff 100%)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Tính năng đã có sẵn</h2>
            <p className="text-gray-500">Xây dựng dành riêng cho thị trường Việt Nam</p>
          </ScrollReveal>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {FEATURES.map(({ icon, iconGrad, cardGrad, bar, title, desc }, i) => (
              <ScrollReveal key={title} delay={i * 50} className="h-full">
                <div className={`relative bg-gradient-to-br ${cardGrad} rounded-2xl p-5 border border-white/80 shadow-sm card-lift h-full overflow-hidden flex flex-col`}>
                  <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${bar}`} />
                  <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${iconGrad} flex items-center justify-center mb-3 shadow-md mt-3 flex-shrink-0`}>
                    {icon}
                  </div>
      ...
      <section className="relative overflow-hidden py-24" style={{ background: 'linear-gradient(135deg, #312e81 0%, #4c1d95 55%, #1e1a4e 100%)' }}>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <ScrollReveal className="text-center mb-16">
            ...
            <p className="text-gray-400">Từ mô tả tiếng Việt đến HTML production-ready</p>
          </ScrollReveal>
            ...
            <ScrollReveal className="flex-1" from="left">
              <div className="h-full bg-white/[0.06] backdrop-blur-md rounded-2xl border border-white/10 p-6 flex flex-col">
                ...
                <div className="bg-white/10 rounded-xl border border-white/10 p-4 flex-1 text-sm text-gray-300 leading-relaxed">
                  Tạo banner quảng cáo mùa hè cho shop thời trang. Nền gradient xanh đậm sang tím. Tiêu đề &ldquo;SALE HÈ 2026&rdquo;, phụ đề &ldquo;Giảm đến 50%&rdquo;. Nút CTA màu vàng &ldquo;Mua ngay&rdquo;.
                </div>
                ...
                <ul className="mt-6 space-y-2.5 flex-1">
                  {[
                    ...
                    <li key={text} className="flex items-center gap-2 text-sm text-gray-600">
                      <CheckCircle2 className={`w-4 h-4 shrink-0 ${ok ? 'text-emerald-500' : 'text-gray-300'}`} />
